...
import edu.upc.fib.freepicrosspfc.managers.DataManager;
...
public class ActivityScores extends Activity{
	...
	private void fillScores() {
        ...
        for(i=0 ; i<15 ; i++) {
        	...
        	case  0: 	tvErrors = (TextView)findViewById(R.id.TextLevel01Errors);
        				tvTime   = (TextView)findViewById(R.id.TextLevel01Time);
        				break;
        	case  1: 	tvErrors = (TextView)findViewById(R.id.TextLevel02Errors);
        				tvTime   = (TextView)findViewById(R.id.TextLevel02Time);
        				break;
        	case  2: 	tvErrors = (TextView)findViewById(R.id.TextLevel03Errors);
        				tvTime   = (TextView)findViewById(R.id.TextLevel03Time);
        				break;
        	case  3: 	tvErrors = (TextView)findViewById(R.id.TextLevel04Errors);
        				tvTime   = (TextView)findViewById(R.id.TextLevel04Time);
        				break;
        	case  4: 	tvErrors = (TextView)findViewById(R.id.TextLevel05Errors);
        				tvTime   = (TextView)findViewById(R.id.TextLevel05Time);
        				break;
        	case  5:	tvErrors = (TextView)findViewById(R.id.TextLevel06Errors);
        				tvTime   = (TextView)findViewById(R.id.TextLevel06Time);
        				break;
        	case  6: 	tvErrors = (TextView)findViewById(R.id.TextLevel07Errors);
        				tvTime   = (TextView)findViewById(R.id.TextLevel07Time);
        				break;
        	case  7:	tvErrors = (TextView)findViewById(R.id.TextLevel08Errors);
        				tvTime   = (TextView)findViewById(R.id.TextLevel08Time);
        				break;
        	case  8:	tvErrors = (TextView)findViewById(R.id.TextLevel09Errors);
        				tvTime   = (TextView)findViewById(R.id.TextLevel09Time);
        				break;
        	case  9:	tvErrors = (TextView)findViewById(R.id.TextLevel10Errors);
        				tvTime   = (TextView)findViewById(R.id.TextLevel10Time);
        				break;
        	case 10:	tvErrors = (TextView)findViewById(R.id.TextLevel11Errors);
        				tvTime   = (TextView)findViewById(R.id.TextLevel11Time);
        				break;
        	case 11:	tvErrors = (TextView)findViewById(R.id.TextLevel12Errors);
        				tvTime   = (TextView)findViewById(R.id.TextLevel12Time);
        				break;
        	case 12: 	tvErrors = (TextView)findViewById(R.id.TextLevel13Errors);
        				tvTime   = (TextView)findViewById(R.id.TextLevel13Time);
        				break;
        	case 13: 	tvErrors = (TextView)findViewById(R.id.TextLevel14Errors);
        				tvTime   = (TextView)findViewById(R.id.TextLevel14Time);
        				break;
        	case 14: 	tvErrors = (TextView)findViewById(R.id.TextLevel15Errors);
        				tvTime   = (TextView)findViewById(R.id.TextLevel15Time);
        				break;
        	default:	tvErrors = null;
						tvTime   = null;
        	}
        	
        	if(errors[i] != -1) tvErrors.setText("Errors: " + strErrors[i]);
        	if(time[i] != -1) tvTime.setText("Temps: " + strTime[i]);
        }
	}
}
