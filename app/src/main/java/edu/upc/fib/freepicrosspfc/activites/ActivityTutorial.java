...
public class ActivityTutorial extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {pressButton(BTN_NEXT);}});
        
        previous.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {pressButton(BTN_PREVIOUS);}});
	...
	private synchronized void pressButton(int button) {
		...
		if(!buttonPressed) {
			...
			case BTN_NEXT: 	   nextPage();     break;
			case BTN_PREVIOUS: previousPage(); break;
			}
	...
	private void nextPage() {
		...
		if(this.page == MAX_PAGES) this.next.setEnabled(false);
		this.printLesson();
	}
	...
	private void previousPage() {
		...
		if(this.page == 1) this.previous.setEnabled(false);
		this.printLesson();
	}
	...
	private void printLesson() {
		...
		case 1: this.text.setText(R.string.textLesson01);
				this.image.setImageResource(R.drawable.tex_1);
				break;
				
		case 2: this.text.setText(R.string.textLesson02);
				this.image.setImageResource(R.drawable.tex_2);
				break;
		
		case 3: this.text.setText(R.string.textLesson03);
