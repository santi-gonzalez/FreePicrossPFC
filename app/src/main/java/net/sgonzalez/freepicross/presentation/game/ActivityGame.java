package net.sgonzalez.freepicross.presentation.game;
...
import net.sgonzalez.freepicross.presentation.opengl.GLView;
    ...
    mTimer = new CountDownTimer(GameManager.getInstance().getTimeMax() * 1000, 1000) {
      ...
      public void onTick(long millisUntilFinished) {
        if (!GameManager.getInstance().isCleared()) {
          ...
          mErrorView.setText(
          "Errors " + GameManager.getInstance().getErrorsCur() + "/" + GameManager.getInstance().getErrorsMax());
        }
      }
