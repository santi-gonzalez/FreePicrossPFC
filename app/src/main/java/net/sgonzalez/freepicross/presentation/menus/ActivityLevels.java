...
extends Activity {
  ...
  private synchronized void launchGame(int level) {
    if (!buttonPressed) {
      ...
      switch (level) {
        case 0:
          GameManager.getInstance().setLevelID(R.raw.level01);
          break;
        case 1:
          GameManager.getInstance().setLevelID(R.raw.level02);
          break;
        case 2:
          GameManager.getInstance().setLevelID(R.raw.level03);
          break;
        case 3:
          GameManager.getInstance().setLevelID(R.raw.level04);
          break;
        case 4:
          GameManager.getInstance().setLevelID(R.raw.level05);
          break;
        case 5:
          GameManager.getInstance().setLevelID(R.raw.level06);
          break;
        case 6:
          GameManager.getInstance().setLevelID(R.raw.level07);
          break;
        case 7:
          GameManager.getInstance().setLevelID(R.raw.level08);
          break;
        case 8:
          GameManager.getInstance().setLevelID(R.raw.level09);
          break;
        case 9:
          GameManager.getInstance().setLevelID(R.raw.level10);
          break;
        case 10:
          GameManager.getInstance().setLevelID(R.raw.level11);
          break;
        case 11:
          GameManager.getInstance().setLevelID(R.raw.level12);
          break;
        case 12:
          GameManager.getInstance().setLevelID(R.raw.level13);
          break;
        case 13:
          GameManager.getInstance().setLevelID(R.raw.level14);
          break;
        case 14:
          GameManager.getInstance().setLevelID(R.raw.level15);
          break;
      }
