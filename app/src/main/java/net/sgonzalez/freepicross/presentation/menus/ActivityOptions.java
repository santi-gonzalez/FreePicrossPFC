...
extends Activity {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    levels.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        pressButton(BTN_LEVELS);
      }
    });
    scores.setOnClickListener(new View.OnClickListener() {

      public void onClick(View view) {
        pressButton(BTN_SCORES);
      }
    });
    tutorial.setOnClickListener(new View.OnClickListener() {

      public void onClick(View view) {
        pressButton(BTN_TUTORIAL);
      }
    });
  ...
  private synchronized void pressButton(int button) {
    if (!buttonPressed) {
      ...
      switch (button) {
        case BTN_LEVELS:
          startActivity(new Intent(this, ActivityLevels.class));
          break;
        case BTN_SCORES:
          startActivity(new Intent(this, ActivityScores.class));
          break;
        case BTN_TUTORIAL:
  ...
  private void writeScores() {
    ...
    if (GameManager.getInstance().isCleared()) {
      DataManager.getInstance()
                 .writeHightScores(GameManager.getInstance().getLevel(), GameManager.getInstance().getErrorsCur(),
  ...
  private void showScores() {
    ...
    builder.setMessage(title).setCancelable(false).setPositiveButton(R.string.choiceOk, new DialogInterface.OnClickListener() {
